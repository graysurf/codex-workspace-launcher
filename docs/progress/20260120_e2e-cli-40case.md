...
| 12 | create_public_ssh_scp_style | `create git@github.com:OWNER/REPO.git` | `CWS_E2E_PUBLIC_REPO`, `CWS_E2E_ENABLE_SSH` | SKIP (needs `CWS_E2E_ENABLE_SSH=1`) | — | — | `out/tests/e2e/cli/create_public_ssh_scp_style/meta.json` |
| 13 | create_public_ssh_url_style | `create ssh://git@github.com/OWNER/REPO.git` | `CWS_E2E_PUBLIC_REPO`, `CWS_E2E_ENABLE_SSH` | SKIP (needs `CWS_E2E_ENABLE_SSH=1`) | — | — | `out/tests/e2e/cli/create_public_ssh_url_style/meta.json` |
...
| 15 | create_seed_private_repo | `create --private-repo OWNER/PRIVATE_REPO OWNER/REPO` | `CWS_E2E_PUBLIC_REPO`, `CWS_E2E_PRIVATE_REPO` | SKIP (needs `CWS_E2E_PRIVATE_REPO`) | — | — | `out/tests/e2e/cli/create_seed_private_repo/meta.json` |
...
| 17 | create_multiple_repos | `create OWNER/REPO OWNER/REPO` | `CWS_E2E_PUBLIC_REPO` | PASS | — | 2026-01-20T22:43:59+0800 | `out/tests/e2e/cli/create_multiple_repos/meta.json` |
...
| 20 | exec_shell | `exec ws-e2e` | `CWS_E2E_ENABLE_EXEC_SHELL` | PASS | — | 2026-01-20T22:44:21+0800 | `out/tests/e2e/cli/exec_shell/meta.json` |
...
| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 23 | auth_github | `auth github ws-e2e` | `CWS_E2E_ENABLE_AUTH` | SKIP (needs `CWS_E2E_ENABLE_AUTH=1`) | — | — | `out/tests/e2e/cli/auth_github/meta.json` |
| 24 | auth_github_host | `auth github --host github.com ws-e2e` | `CWS_E2E_ENABLE_AUTH` | SKIP (needs `CWS_E2E_ENABLE_AUTH=1`) | — | — | `out/tests/e2e/cli/auth_github_host/meta.json` |
| 25 | auth_codex_profile | `auth codex --profile CODEX_PROFILE ws-e2e` | `CWS_E2E_ENABLE_AUTH`, `CWS_E2E_ENABLE_CODEX`, `CWS_E2E_CODEX_PROFILE` | SKIP (needs `CWS_E2E_ENABLE_AUTH=1`) | — | — | `out/tests/e2e/cli/auth_codex_profile/meta.json` |
| 26 | auth_gpg_key | `auth gpg --key GPG_KEY_ID ws-e2e` | `CWS_E2E_ENABLE_AUTH`, `CWS_E2E_ENABLE_GPG`, `CWS_E2E_GPG_KEY_ID` | SKIP (needs `CWS_E2E_ENABLE_AUTH=1`) | — | — | `out/tests/e2e/cli/auth_gpg_key/meta.json` |

### Reset (4)

| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 27 | reset_repo | `reset repo ws-e2e REPO_PATH --yes` | `CWS_E2E_PUBLIC_REPO` | PASS | — | 2026-01-20T22:44:51+0800 | `out/tests/e2e/cli/reset_repo/meta.json` |
| 28 | reset_work_repos | `reset work-repos ws-e2e --yes` | `CWS_E2E_PUBLIC_REPO` | PASS | — | 2026-01-20T22:45:15+0800 | `out/tests/e2e/cli/reset_work_repos/meta.json` |
| 29 | reset_opt_repos | `reset opt-repos ws-e2e --yes` | `CWS_E2E_PUBLIC_REPO` | PASS | — | 2026-01-20T22:45:39+0800 | `out/tests/e2e/cli/reset_opt_repos/meta.json` |
| 30 | reset_private_repo | `reset private-repo ws-e2e --yes` | `CWS_E2E_PUBLIC_REPO`, `CWS_E2E_PRIVATE_REPO` | SKIP (needs `CWS_E2E_PRIVATE_REPO`) | — | — | `out/tests/e2e/cli/reset_private_repo/meta.json` |

### Tunnel (3)

| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 31 | tunnel_foreground | `tunnel ws-e2e` | `CWS_E2E_ENABLE_TUNNEL` | SKIP (needs `CWS_E2E_ENABLE_TUNNEL=1`) | — | — | `out/tests/e2e/cli/tunnel_foreground/meta.json` |
| 32 | tunnel_detach | `tunnel ws-e2e --detach` | `CWS_E2E_ENABLE_TUNNEL` | SKIP (needs `CWS_E2E_ENABLE_TUNNEL=1`) | — | — | `out/tests/e2e/cli/tunnel_detach/meta.json` |
| 33 | tunnel_named | `tunnel ws-e2e --name ws-e2e-tunnel` | `CWS_E2E_ENABLE_TUNNEL` | SKIP (needs `CWS_E2E_ENABLE_TUNNEL=1`) | — | — | `out/tests/e2e/cli/tunnel_named/meta.json` |
...
| 35 | rm_all_yes | `rm --all --yes` | `CWS_E2E_ALLOW_RM_ALL` | SKIP (needs `CWS_E2E_ALLOW_RM_ALL=1`) | — | — | `out/tests/e2e/cli/rm_all_yes/meta.json` |

### Env / config (5)

| # | case_id | args (template) | Gates | R1 | R2 | Updated | Evidence |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 36 | env_custom_image | `ls` (env: `CWS_IMAGE=graysurf/codex-workspace-launcher:latest`) | — | PASS | — | 2026-01-20T22:46:06+0800 | `out/tests/e2e/cli/env_custom_image/meta.json` |
| 37 | env_auth_env | `ls` (env: `CWS_AUTH=env`) | — | PASS | — | 2026-01-20T22:46:27+0800 | `out/tests/e2e/cli/env_auth_env/meta.json` |
